...
export const requiredEstimateFields: Array<keyof EstimateNotificationPayload> = [
  "fullName",
  "phone",
  "email",
  "address",
...
export async function sendEstimateNotification(payload: EstimateNotificationPayload) {
  ...
  if (!response.ok) {
    ...
    throw new Error(`Resend notification failed: ${errorBody}`);
  }
}
